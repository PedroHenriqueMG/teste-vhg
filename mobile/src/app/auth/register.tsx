  ...
  return (
    <View className="size-full flex-1 items-center justify-center p-6 bg-white">
      <View className="w-full max-w-sm space-y-6">
        ...
        {/* Título */}
        <Text className="text-3xl font-extrabold text-center mb-2">Crie sua conta</Text>
        ...
        <View className="space-y-3">
          ...
          <Input variant="underlined" size="lg" className="px-0">
            ...
            <InputSlot onPress={() => setShowConfirmPassword((v) => !v)}>
              <InputIcon as={showConfirmPassword ? EyeOff : Eye} color="#888" />
            </InputSlot>
          </Input>
        </View>
        ...
        <View className="flex-row justify-center items-center mt-2">
          ...
          <TouchableOpacity onPress={() => router.push('/auth/login')}>
            <Text className="text-base text-blue-600 font-semibold">Fazer login →</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
